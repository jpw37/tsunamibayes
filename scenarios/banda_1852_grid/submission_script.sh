...
# Activate Python environment for installing/running GeoClaw
conda activate /fslgroup/fslg_tsunami/jake/hmc 
...
# scendir should be directory containing scenario-specific files (scenario.py, forward.py, etc...)
# rundir should be directory where output will be stored
...
[[ -z $rundir ]] && rundir="/fslgroup/fslg_tsunami/tsunamibayes/tsunamibayes/scenerios/hmc_banda_1852/$jobid"
...
clawver=v5.9.0
# Location of clawpack source (Customize for VT/BYU) - this currently installs claw 5.9.0
