...
def build_gauges():
    ...
    dists['height'] = stats.norm(loc=1.8, scale=0.4)
    gauge = Gauge(name, dists)
    gauge.lat = [4.2606734, 4.2309717, 4.2315381]
    gauge.lon = [117.9005218, 117.8794758, 117.9244083]
    gauge.loc = 1.8
    gauge.scale = 0.4
    gauges.append(gauge)
    ...
    dists['height'] = stats.norm(loc=1.8, scale=0.4)
    gauge = Gauge(name, dists)
    gauge.lat = [1.5140765, 1.4928330, 1.4682564]
    gauge.lon = [124.8366719, 124.8271245, 124.8163795]
    gauge.loc = 1.8
    gauge.scale = 0.4
    gauges.append(gauge)
    ...
    dists['height'] = stats.norm(loc=1.8, scale=0.4)
    gauge = Gauge(name, dists)
    gauge.lat = [0.9347793, 0.9342088, 0.9360681]
    gauge.lon = [123.0321952, 123.0376047, 123.0399715]
    gauge.loc = 1.8
    gauge.scale = 0.4
    gauges.append(gauge)
