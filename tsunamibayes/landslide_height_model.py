...
class LandslideHeightModel:
    def __init__(self, center_mass_depth, thickness, landslide_speed, lat1, lon1, lat2, lon2, volume, aspect_ratio):
    ...
    def convert_size(self):
        self.length = (self.volume/self.thickness) * self.aspect_ratio
        self.width = (self.volume/self.thickness)/self.length
...
if __name__ == '__main__':
    ...
    landslideheightmodel = LandslideHeightModel(center_mass_depth, thickness, landslide_speed, lat1, lon1, lat2, lon2, volume, aspect_ratio)
