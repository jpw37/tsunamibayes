...
class TimeModelSimpsons:
    ...
    def __init__(self, control_points, file_path):
        """
        ...
        self.matrix = self.read_file_into_matrix(file_path)
...
if __name__ == "__main__":
    file_path = r"C:\Users\ashle\Documents\Whitehead Research\Research 2023\1852\.ipynb_checkpoints\TIme Project\data.txt"
    ...
    runner = TimeModelSimpsons(control_points, file_path)
    result = runner.simpson(0.0, 1.0, 10)
